/* @ts-self-types="./tacobell_finder.d.ts" */
 ...
 * @returns {number}
 */
export function dataset_size() {
    const ret = wasm.dataset_size();
    return ret >>> 0;
}
 ...
 * @returns {any}
 */
export function find_nearest_three(lat, lon) {
    const ret = wasm.find_nearest_three(lat, lon);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('tacobell_finder_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
